...
import 'package:q_r_firebase/data/config.dart';
...
class QuizCubitPage extends StatefulWidget{
  @override
  _QuizCubitPage createState() => _QuizCubitPage();

}
class _QuizCubitPage extends State<QuizCubitPage>{
